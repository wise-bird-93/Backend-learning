...
exports.editHome = (req,res,next) => {
  ...
  Home.findById(homeId).then(home => {
    ...
    if(!home){
      ...
      res.render('host/editHome',{home: home, pageTitle: "EditHome" ,currentPage: "EditHome", isLoggedIn: req.isLoggedIn}); 
    }  
...
exports.viewHomes = (req,res,next) => {
  Home.find().then(registeredHomes => {
    res.render('host/home',{registeredHomes: registeredHomes, pageTitle: 'airbnb home', currentPage: 'Home', isLoggedIn: req.isLoggedIn});
  });
...
exports.getHomeDetails = (req,res,next) => {
  ...
  Home.findById(homeId).then(homes => {
      if (!homes) {
        ...
        res.render('host/home-details',{home: homes, pageTitle: homes.houseName, currentPage: 'HomeDetail', isLoggedIn: req.isLoggedIn});
      }
    }).catch(err => console.log(err));
